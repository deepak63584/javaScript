...
class cliniqueManagement extends clinique {
    ...
    takeAppointment() {
        ...
        for (let key in this.data.doctor) {
            if (this.data.doctor[key].doctorName == dr_Name) {
                index = key;
            }
        }
        if (index != -1) {
    ...
    checkAppoinment() {
        ...
        if (index == -1) {
            ...
            console.log(`Doctor Name : ${this.data.cliniqueAppointment[index].dr_Name}`);
        ...
        do {
            ...
            if (cancel == 'Y' || cancel == 'y') {
                ...
                let dr_Name = this.data.cliniqueAppointment[index].dr_Name;

                let index2 = -1;
                for (let key in this.data.doctor) {
                    if (this.data.doctor[key].dr_Name == dr_Name) {
                        index2 = key;
                    }
                }
        ...
        switch (choice) {
            ...
            case 1:
                ...
                for (let i in this.data.doctor) {
                    if (this.data.doctor[i].doctorName == dr_Name) {
            ...
            case 2:
                ...
                for (let i in this.data.doctor) {
                    ...
                    if (this.data.doctor[i].dr_Id == dr_Id) {
    ...
    searchPatient() {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                for (let i in this.data.patient) {
                    if (this.data.patient[i].p_Id == p_Id) {
                        //console.log(this.data.patient[i]);
                        console.table(this.data.patient[i]);
                    }
                }
